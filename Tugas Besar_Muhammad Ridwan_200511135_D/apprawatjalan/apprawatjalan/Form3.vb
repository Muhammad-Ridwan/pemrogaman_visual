...
Public Class Form3
    Private Sub TambahData()
        ...
        Dim biaya As String = txtBiaya.Text
        Dim hasil_diagnosa As String = txtDiagnosa.Text
        Dim harga_obat As String = txtObat.Text
        Dim total As String = txtTotal.Text

        Dim postData As String = $"no_recmd={no_recmd}&nrp={nrp}&nama={nama}&nama_dokter={nama_dokter}&biaya={biaya}&hasil_diagnosa={hasil_diagnosa}&harga_obat={harga_obat}&total={total}"
    ...
    Private Sub UpdateData()
        ...
        Try
            ...
            Dim responseBytes As Byte() = client.UploadData(rawatjalan_api & "?no_recmd=" & txtNorecmd.Text, "PUT", byteArray)
