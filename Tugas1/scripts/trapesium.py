...
class FrmTrapesium:
 ...
 # pasang Label
        Label(mainFrame, text='Alas a :').grid(row=0, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Alas b :').grid(row=1, column=0, sticky=W, padx=5, pady=5)
...
if __name__ == '__main__':
    root = Tk()
    aplikasi = FrmTrapesium(root, "OOP! Program Menghitung Luas dan Keliling Trapesium")
    root.mainloop()